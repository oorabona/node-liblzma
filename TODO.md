...
- [x] ✅ [Release] Scope `nxz` → `@oorabona/nxz` — unscoped `nxz` blocked by npm typosquat protection (403); `@oorabona/nxz` confirmed available (404); package.json, CHANGELOG v7.0.0 entry, README, docs, and workflow refs updated — closes PR #135
