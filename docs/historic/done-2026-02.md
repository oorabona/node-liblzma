...
## Archived on 2026-02-28 (from /finalize: CLI-NXZ-MIGRATION)
...
- [x] ✅ [CLI] Déplacer src/cli/nxz.ts → packages/nxz/src/ pour casser le cycle de build et activer import type from 'tar-xz' (2026-02-28)
